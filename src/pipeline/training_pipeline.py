...
class TrainingPipeline:
    ...
    def start_data_transformation(elf,feature_store_file_path):

        try:

            data_transformation=DataTransformation(feature_store_file_path=feature_store_file_path)

            train_arr,test_arr,preprocessor_path= data_transformation.initiate_data_transformer()
    ...
    def run_pipeline(self):
        try:
            ...
            print("training completed trined model score",r2_square)
